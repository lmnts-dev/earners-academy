		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 5, 2023 <span class="changelog-version">Lite Version 5.2.17</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Heading Title : Responsive Compatibility for Separator Height and Width', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Video : Responsive Compatibility for Icon Size', 'tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">October 5, 2023 <span class="changelog-version">Pro Version 5.2.17</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Update : Heading Title : Responsive Compatibility for Separator Height and Width', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Video : Responsive Compatibility for Icon Size', 'tpebl').'</li>';
							echo '<li>'.esc_html__('Fix : Minor bug fixes & Improvements', 'tpebl').'</li>';
